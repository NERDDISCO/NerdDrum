...
var _ndConnector = require("./lib/ndConnector");

var _ndMidi = require("./lib/ndMidi");

var connect = new _ndConnector.ndConnector({
  url: 'localhost:1337'
});

var midi = new _ndMidi.ndMidi({
  debug: true
});
...
var ndConnector = exports.ndConnector = function () {
  function ndConnector(args) {
    _classCallCheck(this, ndConnector);
    ...
    this.webSocket = (0, _socket2.default)(this.url + '/' + this.namespace);
  }
...
},{"socket.io-client":2}],51:[function(require,module,exports){
'use strict';
...
var ndMidi = exports.ndMidi = function () {
